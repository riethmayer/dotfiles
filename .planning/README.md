...
| Sprint | Area | Priority | Effort |
|--------|------|----------|--------|
| 1 | Zsh Config Consolidation | High | Large |
| 2 | Claude Config Cleanup | High | Small |
| 3 | OpenCode Configuration | High | Medium |
| 4 | Bootstrap Script Fixes | Medium | Small |
| 5 | XDG Compliance | Medium | Medium |
| 6 | Missing Stow Packages | Medium | Medium |
